...
rem  Versie: 1.7.4 (Altijd fallback op standaardstructuur, alle categorieën batch)
rem  Maakt een persoonlijke mappenstructuur aan op basis van .txt bestand of default
...
if "!USE_EXTERNAL_MAP_FILE!"=="true" (
    ...
    rem ---- STANDAARDSTRUCTUUR, ALLE CATEGORIEËN (uitgebreid) ----
