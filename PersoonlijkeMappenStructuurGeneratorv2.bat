...
rem  Versie: 1.7.3 (Stabiliteitsverbetering: geen GOTO in FOR-loop, robuuster)
...
if "!USE_EXTERNAL_MAP_FILE!"=="true" (
    ...
    :: Voeg hier je standaardstructuur toe zoals eerder in jouw script
    :: (Uitgeknipt voor beknoptheid)
    rem ...  
)
